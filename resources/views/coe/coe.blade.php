                            ...
                            <form ng-model="employeeDetails">
                                <div class="form-row" style="border:red;">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <textarea class="form-control" ng-model="coeCtrl.coeDetails.remarks"></textarea>
                                    </div> 
                                ...
                                <table class="table" datatable="ng" dt-instance="tc.dtInstance" dt-options="tc.dtOptions" style="width:100%">
                                    ...
                                    <tbody>
                                        <tr ng-repeat="coe in coeCtrl.coe">
                                            ...
                                            <td>
                                                <a href="#" ng-if="coe.is_self_service == 1" class="btn btn-danger btn-xs" ng-click="coeCtrl.printCoeBtn(coe.coe_code)" style="margin-top:12px;" title="Print Preview"><i class="ti-printer"></i></a>
                                                <a href="#" ng-if="coe.is_self_service == 0" class="btn btn-danger btn-xs" ng-click="coeCtrl.printCoeOriginalSigBtn(coe.coe_code)" style="margin-top:12px;" title="View Status"><i class="ti-eye"></i></a>
                                                <!-- @if(Auth::user()->is_admin==1)
                                                <a href="#" class="btn btn-danger btn-xs" ng-if="coeCtrl.is_hide" ng-click="coeCtrl.viewCoeOriginalSigBtn(coe.coe_code)" style="margin-top:12px;">VIEW DETAILS - Admin</a>
                                                @endif -->
                                            </td>
                                        </tr>
                                    </tbody>
